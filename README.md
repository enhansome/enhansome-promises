...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 495,052 | 🐛 100 | 📅 2026-06-30 list thing. Not to be confused with other awesome promises like "I promise you a million dollars" or "I promise you'll stay fit and never have to go to the gym again".
...
* [You Don't Know JS: Promises](https://github.com/getify/You-Dont-Know-JS/blob/master/async%20&%20performance/ch3.md) ⭐ 184,652 | 🐛 2 | 📅 2026-02-15 - Chapter from [You Don't Know JS: Async & Performance](https://github.com/getify/You-Dont-Know-JS/tree/master/async%20%26%20performance) ⭐ 184,652 | 🐛 2 | 📅 2026-02-15
...
* [Promise anti-patterns](https://github.com/petkaantonov/bluebird/wiki/Promise-anti-patterns) ⭐ 20,502 | 🐛 131 | 🌐 JavaScript | 📅 2024-11-07 - Common misuses and how to avoid them.
...
* [es6-promise](https://github.com/stefanpenner/es6-promise) ⭐ 7,256 | 🐛 26 | 🌐 JavaScript | 📅 2022-11-14 - Opt-in polyfill. A strict-spec subset of rsvp.js.
* [lie](https://github.com/calvinmetcalf/lie) ⭐ 743 | 🐛 5 | 🌐 JavaScript | 📅 2020-08-21 - Small, browserifyable with an opt-in polyfill.
* [native-promise-only](https://github.com/getify/native-promise-only) ⚠️ Archived - Polyfill. Browser and node-compatible.
* [pinkie](https://github.com/floatdrop/pinkie) ⭐ 138 | 🐛 2 | 🌐 JavaScript | 📅 2018-08-20 - Ponyfill. Node-oriented, but [browserifyable](https://github.com/substack/node-browserify) ⭐ 14,697 | 🐛 380 | 🌐 JavaScript | 📅 2024-12-21. *Extremely* small implementation.

### Implementations with extras

All of these provide more features than the language yet remain compatible. Node + Browsers for all.

* [bluebird](https://github.com/petkaantonov/bluebird) ⭐ 20,502 | 🐛 131 | 🌐 JavaScript | 📅 2024-11-07 - Fully featured, extremely performant. Long stack traces & generator/coroutine support.
...
* [pinkie-promise](https://github.com/floatdrop/pinkie-promise) ⭐ 115 | 🐛 3 | 🌐 JavaScript | 📅 2018-05-22 - Use native, or fall back to `pinkie`. Great for node library authors.
...
### sindresorhus's many Promise utilities ([see notes](https://github.com/sindresorhus/promise-fun) ⭐ 5,161 | 🐛 0 | 📅 2024-04-25)

* [p-queue](https://github.com/sindresorhus/p-queue) ⭐ 4,259 | 🐛 5 | 🌐 TypeScript | 📅 2026-07-22 - Promise queue with concurrency control
* [p-limit](https://github.com/sindresorhus/p-limit) ⭐ 2,912 | 🐛 0 | 🌐 JavaScript | 📅 2026-07-20 - Run multiple promise-returning & async functions with limited concurrency
...
* [p-retry](https://github.com/sindresorhus/p-retry) ⭐ 1,025 | 🐛 1 | 🌐 JavaScript | 📅 2026-03-26 - Retry a promise-returning or async function
...
* [p-debounce](https://github.com/sindresorhus/p-debounce) ⭐ 237 | 🐛 4 | 🌐 JavaScript | 📅 2025-11-11 - Debounce promise-returning & async functions
* [p-props](https://github.com/sindresorhus/p-props) ⭐ 202 | 🐛 0 | 🌐 JavaScript | 📅 2025-09-21 - Like `Promise.all()` but for `Map` and `Object`
...
* [p-each-series](https://github.com/sindresorhus/p-each-series) ⭐ 53 | 🐛 0 | 🌐 JavaScript | 📅 2022-07-08 - Iterate over promises serially
...
* [p-some](https://github.com/sindresorhus/p-some) ⭐ 40 | 🐛 0 | 🌐 JavaScript | 📅 2025-09-11 - Wait for a specified number of promises to be fulfilled
...
* [co](https://github.com/tj/co) ⭐ 11,841 | 🐛 44 | 🌐 JavaScript | 📅 2020-12-15 - Like `task.js` and `bluebird.coroutine`, but supports thunks too.
