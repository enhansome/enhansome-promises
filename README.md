...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 507,508 | 🐛 106 | 📅 2026-09-02 list thing. Not to be confused with other awesome promises like "I promise you a million dollars" or "I promise you'll stay fit and never have to go to the gym again".
...
* [You Don't Know JS: Promises](https://github.com/getify/You-Dont-Know-JS/blob/master/async%20&%20performance/ch3.md) ⭐ 184,924 | 🐛 2 | 📅 2026-02-15 - Chapter from [You Don't Know JS: Async & Performance](https://github.com/getify/You-Dont-Know-JS/tree/master/async%20%26%20performance) ⭐ 184,924 | 🐛 2 | 📅 2026-02-15
...
* [Promise anti-patterns](https://github.com/petkaantonov/bluebird/wiki/Promise-anti-patterns) ⭐ 20,487 | 🐛 130 | 🌐 JavaScript | 📅 2024-11-07 - Common misuses and how to avoid them.
* [Promise Fun](https://github.com/sindresorhus/promise-fun) ⭐ 5,172 | 🐛 0 | 📅 2024-04-25 - @sindresorhus's notes, patterns, and solutions to common Promise problems
...
* [es6-promise](https://github.com/stefanpenner/es6-promise) ⭐ 7,250 | 🐛 26 | 🌐 JavaScript | 📅 2022-11-14 - Opt-in polyfill. A strict-spec subset of rsvp.js.
...
* [pinkie](https://github.com/floatdrop/pinkie) ⚠️ Archived - Ponyfill. Node-oriented, but [browserifyable](https://github.com/substack/node-browserify) ⭐ 14,695 | 🐛 387 | 🌐 JavaScript | 📅 2026-09-18. *Extremely* small implementation.

### Implementations with extras

All of these provide more features than the language yet remain compatible. Node + Browsers for all.

* [bluebird](https://github.com/petkaantonov/bluebird) ⭐ 20,487 | 🐛 130 | 🌐 JavaScript | 📅 2024-11-07 - Fully featured, extremely performant. Long stack traces & generator/coroutine support.
* [Q](https://github.com/kriskowal/q) ⚠️ Archived - One of the original implementations. Long stack traces and other goodies.
* [rsvp.js](https://github.com/tildeio/rsvp.js/) ⭐ 3,592 | 🐛 17 | 🌐 JavaScript | 📅 2023-10-27 - Lightweight with a few extras. Compatible down to IE6!
...
* [then/promise](https://github.com/then/promise) ⭐ 2,585 | 🐛 24 | 🌐 JavaScript | 📅 2023-10-21 - Small with `nodeify`, `denodify` and `done()` additions.
...
* [any-promise](https://github.com/kevinbeaty/any-promise) ⭐ 177 | 🐛 6 | 🌐 JavaScript | 📅 2018-10-01 - Loads the first available implementation. Safe for browserify.
...
### sindresorhus's many Promise utilities ([see notes](https://github.com/sindresorhus/promise-fun) ⭐ 5,172 | 🐛 0 | 📅 2024-04-25)

* [p-queue](https://github.com/sindresorhus/p-queue) ⭐ 4,276 | 🐛 7 | 🌐 TypeScript | 📅 2026-07-22 - Promise queue with concurrency control
...
* [p-all](https://github.com/sindresorhus/p-all) ⭐ 346 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-18 - Run promise-returning & async functions concurrently with optional limited concurrency
...
* [loud-rejection](https://github.com/sindresorhus/loud-rejection) ⭐ 280 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-18 - Make unhandled promise rejections fail loudly instead of the default silent fail.
...
* [p-filter](https://github.com/sindresorhus/p-filter) ⭐ 82 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-18 - Filter promises concurrently
* [p-time](https://github.com/sindresorhus/p-time) ⭐ 73 | 🐛 0 | 🌐 JavaScript | 📅 2023-11-05 - Measure the time a promise takes to resolve
* [p-reduce](https://github.com/sindresorhus/p-reduce) ⭐ 73 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-18 - Reduce a list of values using promises into a promise for a value
* [p-if](https://github.com/sindresorhus/p-if) ⭐ 64 | 🐛 0 | 🌐 TypeScript | 📅 2021-04-09 - Conditional promise chains
* [p-try](https://github.com/sindresorhus/p-try) ⭐ 62 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-18 - `Promise#try()` ponyfill - Starts a promise chain
...
* [p-any](https://github.com/sindresorhus/p-any) ⭐ 56 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-18 - Wait for any promise to be fulfilled
* [p-each-series](https://github.com/sindresorhus/p-each-series) ⭐ 52 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-18 - Iterate over promises serially
...
* [co](https://github.com/tj/co) ⭐ 11,834 | 🐛 44 | 🌐 JavaScript | 📅 2020-12-15 - Like `task.js` and `bluebird.coroutine`, but supports thunks too.
...
* [promise-nodeify](https://github.com/kevinoid/promise-nodeify) ⭐ 2 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-16 - Standalone `nodeify` method which calls a Node-style callback on resolution or rejection.
