...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 506,391 | 🐛 106 | 📅 2026-09-02 list thing. Not to be confused with other awesome promises like "I promise you a million dollars" or "I promise you'll stay fit and never have to go to the gym again".
...
* [You Don't Know JS: Promises](https://github.com/getify/You-Dont-Know-JS/blob/master/async%20&%20performance/ch3.md) ⭐ 184,907 | 🐛 2 | 📅 2026-02-15 - Chapter from [You Don't Know JS: Async & Performance](https://github.com/getify/You-Dont-Know-JS/tree/master/async%20%26%20performance) ⭐ 184,907 | 🐛 2 | 📅 2026-02-15
...
* [Promise anti-patterns](https://github.com/petkaantonov/bluebird/wiki/Promise-anti-patterns) ⭐ 20,485 | 🐛 130 | 🌐 JavaScript | 📅 2024-11-07 - Common misuses and how to avoid them.
...
* [bluebird](https://github.com/petkaantonov/bluebird) ⭐ 20,485 | 🐛 130 | 🌐 JavaScript | 📅 2024-11-07 - Fully featured, extremely performant. Long stack traces & generator/coroutine support.
...
* [p-queue](https://github.com/sindresorhus/p-queue) ⭐ 4,272 | 🐛 7 | 🌐 TypeScript | 📅 2026-07-22 - Promise queue with concurrency control
...
* [promise-nodeify](https://github.com/kevinoid/promise-nodeify) ⭐ 2 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-15 - Standalone `nodeify` method which calls a Node-style callback on resolution or rejection.
