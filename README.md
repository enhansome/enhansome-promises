...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 508,237 | 🐛 106 | 📅 2026-09-02 list thing. Not to be confused with other awesome promises like "I promise you a million dollars" or "I promise you'll stay fit and never have to go to the gym again".
...
* [You Don't Know JS: Promises](https://github.com/getify/You-Dont-Know-JS/blob/master/async%20&%20performance/ch3.md) ⭐ 184,933 | 🐛 2 | 📅 2026-02-15 - Chapter from [You Don't Know JS: Async & Performance](https://github.com/getify/You-Dont-Know-JS/tree/master/async%20%26%20performance) ⭐ 184,933 | 🐛 2 | 📅 2026-02-15
...
* [Promise Fun](https://github.com/sindresorhus/promise-fun) ⭐ 5,170 | 🐛 0 | 📅 2024-04-25 - @sindresorhus's notes, patterns, and solutions to common Promise problems
...
* [pinkie](https://github.com/floatdrop/pinkie) ⚠️ Archived - Ponyfill. Node-oriented, but [browserifyable](https://github.com/substack/node-browserify) ⭐ 14,696 | 🐛 386 | 🌐 JavaScript | 📅 2026-09-18. *Extremely* small implementation.
...
### sindresorhus's many Promise utilities ([see notes](https://github.com/sindresorhus/promise-fun) ⭐ 5,170 | 🐛 0 | 📅 2024-04-25)
