...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 507,163 | 🐛 106 | 📅 2026-09-02 list thing. Not to be confused with other awesome promises like "I promise you a million dollars" or "I promise you'll stay fit and never have to go to the gym again".
...
* [You Don't Know JS: Promises](https://github.com/getify/You-Dont-Know-JS/blob/master/async%20&%20performance/ch3.md) ⭐ 184,922 | 🐛 2 | 📅 2026-02-15 - Chapter from [You Don't Know JS: Async & Performance](https://github.com/getify/You-Dont-Know-JS/tree/master/async%20%26%20performance) ⭐ 184,922 | 🐛 2 | 📅 2026-02-15
...
* [p-queue](https://github.com/sindresorhus/p-queue) ⭐ 4,273 | 🐛 7 | 🌐 TypeScript | 📅 2026-07-22 - Promise queue with concurrency control
* [p-limit](https://github.com/sindresorhus/p-limit) ⭐ 2,925 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-31 - Run multiple promise-returning & async functions with limited concurrency
...
* [p-throttle](https://github.com/sindresorhus/p-throttle) ⭐ 522 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-12 - Throttle promise-returning & async functions
