...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 509,438 | 🐛 106 | 📅 2026-09-02 list thing. Not to be confused with other awesome promises like "I promise you a million dollars" or "I promise you'll stay fit and never have to go to the gym again".
...
* [You Don't Know JS: Promises](https://github.com/getify/You-Dont-Know-JS/blob/master/async%20&%20performance/ch3.md) ⭐ 184,944 | 🐛 2 | 📅 2026-02-15 - Chapter from [You Don't Know JS: Async & Performance](https://github.com/getify/You-Dont-Know-JS/tree/master/async%20%26%20performance) ⭐ 184,944 | 🐛 2 | 📅 2026-02-15
...
* [Promise anti-patterns](https://github.com/petkaantonov/bluebird/wiki/Promise-anti-patterns) ⭐ 20,486 | 🐛 130 | 🌐 JavaScript | 📅 2024-11-07 - Common misuses and how to avoid them.
...
* [es6-promise](https://github.com/stefanpenner/es6-promise) ⭐ 7,248 | 🐛 26 | 🌐 JavaScript | 📅 2022-11-14 - Opt-in polyfill. A strict-spec subset of rsvp.js.
...
* [bluebird](https://github.com/petkaantonov/bluebird) ⭐ 20,486 | 🐛 130 | 🌐 JavaScript | 📅 2024-11-07 - Fully featured, extremely performant. Long stack traces & generator/coroutine support.
...
* [loud-rejection](https://github.com/sindresorhus/loud-rejection) ⭐ 279 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-18 - Make unhandled promise rejections fail loudly instead of the default silent fail.
