...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 506,061 | 🐛 106 | 📅 2026-09-02 list thing. Not to be confused with other awesome promises like "I promise you a million dollars" or "I promise you'll stay fit and never have to go to the gym again".
...
* [You Don't Know JS: Promises](https://github.com/getify/You-Dont-Know-JS/blob/master/async%20&%20performance/ch3.md) ⭐ 184,894 | 🐛 2 | 📅 2026-02-15 - Chapter from [You Don't Know JS: Async & Performance](https://github.com/getify/You-Dont-Know-JS/tree/master/async%20%26%20performance) ⭐ 184,894 | 🐛 2 | 📅 2026-02-15
...
* [promise-nodeify](https://github.com/kevinoid/promise-nodeify) ⭐ 2 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-14 - Standalone `nodeify` method which calls a Node-style callback on resolution or rejection.
